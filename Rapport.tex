...
On présente ci-dessous (figure \ref{hist}) l'histogramme obtenu pour cette nouvelle variable ainsi que son boxplot en fonction des 4 types de virus.
 ...
 \begin{figure}[!ht]
	\centering
     	\subfigure[Histogramme du nombre total d'acides aminés]{ \includegraphics[scale=0.38]{PB4/Plot/RplotHist.eps} }
	\subfigure[Boxplot par type de virus]{ \includegraphics[scale=0.38]{PB4/Plot/RplotBoxplot.eps} }
...
\subsection{Espace des individus}
	...
	\centering
     	\subfigure[Espace des individus sur les axes 1 et 2.]{\includegraphics[scale=0.5]{PB4/Plot/RplotACP1.eps}}
	\subfigure[Espace des individus sur les axes 3 et 4.]{\includegraphics[scale=0.5]{PB4/Plot/RplotACP2.eps}}
...
\subsection{Espace des variables}
	...
	\centering
     	\subfigure[Espace des variables sur les axes 1 et 2.]{\includegraphics[scale=0.5]{PB4/Plot/RplotACP3.eps}}
	\subfigure[Espace des variables sur les axes 3 et 4.]{\includegraphics[scale=0.5]{PB4/Plot/RplotACP4.eps}}
...
Pour aller plus loin dans ce regroupement de variables, la procédure VARCLUS de SAS fournit une solution de classification de variables\footnote{Pour des détails sur cette procédure, voir seciton 9.14 de l'ouvrage de S.TUFFÉRY}. Notons simplement qu'elle confirme assez les regroupements précédents. 
 ...
 \begin{figure}[!ht]
	\centering
     	\includegraphics[scale=0.4]{PB4/Plot/varclus.png}
...
\lstinputlisting[]{./PB1/pb1.sas}
 ...
 Pour \verb|R| : 
  \lstinputlisting[firstline=4, lastline=49]{./PB4/pb4_2603.R}

Pour \verb|SAS| : 
\lstinputlisting[]{./PB4/pb4.sas}
